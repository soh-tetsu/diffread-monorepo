-- Migration: Fix claim_article_for_scraping to use api schema
-- Purpose: Move RPC function from public to api schema
-- Date: 2025-12-07

-- Drop the function from public schema if it exists
DROP FUNCTION IF EXISTS public.claim_article_for_scraping(BIGINT);
