...
const CONCEPTUAL_POOL: TaskTemplate[] = [
  ...
  },
  {
    id: "Task_Example",
    description:
      "Deconstruct the author's primary example to see how it illustrates the concept.",
    questionType: "implicit",
  },
  {
    id: "Task_Implication",
...
const ARGUMENTATIVE_POOL: TaskTemplate[] = [
  ...
  },
  {
    ...
    description:
      "Generate a logical counterargument to the thesis that '{core_thesis}'",
    questionType: "implicit",
  },
];
...
const PROCEDURAL_POOL: TaskTemplate[] = [
  ...
  },
  {
    ...
    description:
      "List the prerequisites, materials, or setup needed before starting.",
    questionType: "confirmative",
  },
  {
    id: "Task_Confirm_Steps",
    description:
      "Break down the procedure into its main, sequential steps or stages.",
    questionType: "explicit",
  },
  {
    id: "Task_Check_Outcome",
    description:
      "Identify the expected result or how to verify success after finishing.",
    questionType: "explicit",
  },
];
