import { z } from "zod";
import { Pipeline, type LLMStep, type StepDependencies } from "../prompts/pipeline";
import { analysisPromptV2, hookGeneratorPromptV2 } from "../prompts/v2";
 ...
 */
const analysisLLMStep: LLMStep<CuriosityQuestionWorkflowInput, AnalysisStepOutput> = {
