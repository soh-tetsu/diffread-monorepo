...
import type { ArticleMetadata, HookQuestion, QuestionEngineOptions } from './types'
...
export async function generateHookQuestions(
  ...
  try {
    ...
    throw new Error(`Failed to parse hook questions JSON (prompt ${strategyPrompt.id}): ${snippet}`)
  }
